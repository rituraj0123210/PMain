...
class BeneficiaryListKisan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_beneficiary_list_kisan)
        ...
        webView.loadUrl("https://pmkisan.gov.in/Rpt_BeneficiaryStatus_pub.aspx")
    }
