...
class AwasUrbanList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_awas_urban_list)

        supportActionBar?.apply {
            title = "Awas Yojna Urban List"
        ...
        webView.loadUrl("https://bhuvan-app1.nrsc.gov.in/hfa/usrtasks/housingforall/dashboard_public/index.php")
    }
