...
class AwasYojnaList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_awas_yojna_list)

        supportActionBar?.apply {
            title = "Awas Yojna Rural List"
        ...
        webView.loadUrl("https://rhreporting.nic.in/netiay/SECCReport/report_categorywiseseccverification.aspx")
    }
