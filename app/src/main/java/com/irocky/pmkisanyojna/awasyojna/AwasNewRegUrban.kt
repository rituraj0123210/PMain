...
class AwasNewRegUrban : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_awas_new_reg_urban)

        supportActionBar?.apply {
            title = "Awas Registration Urban"
        ...
        webView.loadUrl("https://pmaymis.gov.in/")
    }
